# 🧭 Living Task Framework — Prompt Collection
...
> We are exploring Contextual Reference Prompting (CIP) — where AI integrates immediate and background context.
...
> Using Vector Synthesis (VS) — where multiple frames of comparison are semantically balanced — compare Tailwind and MUI for a NextJS healthcare app.
...
VECTOR SYNTHESIS: Analyze this across 3 lenses — cultural, operational, and strategic — showing how each transforms under collaborative AI adoption.
REFLECTIVE: Close by highlighting how readers might recognize early indicators of reflective maturity in their teams.
```

- --

## 🔄 2. Context Transfer Prompts — Cross-Model Continuity

### Prompt 1 — Context Compression (CIP Snapshot)
...
> Your role is to continue as a co-thinker — not a summarizer — preserving conceptual continuity and helping integrate prior insights.
> Begin by restating the active goals, then resume synthesis.

### Prompt 2 — Portable Memory Bridge (Meta-Prompted Transfer)
...
### Prompt 3 — Project State Sync (System Transfer)
...
### Prompt 4 — Vector State Injection (VS Seed Transfer)

> Below is a brief context vector summary representing the last major insights in another conversation:
> [Insert condensed bullet summary of discoveries — e.g., CIP layers, dashboard structure, DMP definitions.]
> Rebuild this into a usable working memory, applying Vector Synthesis reasoning.
> Use reflection to align your language model’s approach with that of the prior system.

### Prompt 5 — Full DMP Cross-Context Prompt (Hybridized Seed)
...
REFLECTIVE: Propose a continuity plan — what threads to revisit, what new dimensions to explore, and how to track reflection cycles going forward.
```

- --

## 🗂 3. Suggested Markdown File Structure
...
## 🧭 4. Usage Guide — How to Apply These Prompts
...
2. Paste one of the Context Transfer prompts (Prompt 1–5).
