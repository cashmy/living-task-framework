...
.DESCRIPTION
  ...
  - Types: test, pivotal, session, burst, checkpoint, archive
...
.PARAMETER Type
  Snapshot type: test, pivotal, session, burst, checkpoint, archive. Default: session
...
param(
  [string]$Project = "",
  [ValidateSet("test", "pivotal", "session", "burst", "checkpoint", "archive")]
  [string]$Type = "session",
  [string]$Label = "",
  [string]$Mnemonic = "",
  [string]$Notes = "",
